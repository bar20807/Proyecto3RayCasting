...
class Raycaster (object):
    ...
    def game_over(self):
        lose_sound = pygame.mixer.Sound('./Proyecto_3_Utilidades/perder.wav')
    ...
    def game_win(self):
        win_sound = pygame.mixer.Sound('./Proyecto_3_Utilidades/ganar.wav')
    ...
    def sound(self):
        pygame.mixer.music.load('./Proyecto_3_Utilidades/fondo.wav')
...
r.load_map('./Proyecto_3_Utilidades/map.txt')
